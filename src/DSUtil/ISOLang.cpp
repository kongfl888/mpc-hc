...
namespace
{
    constexpr ISOLang s_isolangs[] = {  // TODO : fill LCID !!!
        ...
        { "Chinese (traditional)", "cht", "",        MAKELCID(MAKELANGID(LANG_CHINESE, SUBLANG_CHINESE_TRADITIONAL), SORT_DEFAULT) },
        { "Chinese (simplified)", "chs", "",         MAKELCID(MAKELANGID(LANG_CHINESE, SUBLANG_CHINESE_SIMPLIFIED), SORT_DEFAULT) },
        { "Chinese bilingual", "zhe", "ze" },
        { "Yue Chinese", "yue", "",                  MAKELCID(MAKELANGID(LANG_CHINESE, SUBLANG_CHINESE_HONGKONG), SORT_DEFAULT) },
        { "Chinook jargon", "chn", "" },
        { "Chipewyan", "chp", "" },
        { "Choctaw", "cho", "" },
